...
public class TextEncryptionPanel extends JPanel {
	  private JComboBox<String> typeComboBox;
	    private JComboBox<String> ClassicComboBox;
	    ...
	    private JButton generateKeyButton, loadKeyButton, encryptButton, decryptButton ;
	    ...
	    private void createUI() {
	        ...
	        setBorder(BorderFactory.createTitledBorder("Mã hóa Text"));
	        ...
	        cardPanel.add(createClassicalPanel(), "Classic");
	    ...
	    private JPanel createTypeSelectorPanel() {
	        ...
	        String[] types = { "Symmetric", "Asymmetric", "Classic", "Hash" };
	    ...
	    private JPanel createClassicalPanel() {
	        JPanel panel = new JPanel(new FlowLayout(FlowLayout.LEFT));
	        String[] algorithms = new String[] { "Ceasar", "Vigenere", "Substitution", "Affine","Hill" };
	        panel.add(new JLabel("Chọn thuật toán:"));
	        ClassicComboBox = new JComboBox<>(algorithms);
	        ClassicComboBox.addActionListener(e -> {
	            selectedAlgo = (String) ClassicComboBox.getSelectedItem();
	            System.out.println(selectedAlgo);
	        });
	        panel.add(ClassicComboBox);
	    ...
	    private void decryptData() throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
	            IllegalBlockSizeException, BadPaddingException, Exception {
	        String encryptedData = outputArea.getText();
